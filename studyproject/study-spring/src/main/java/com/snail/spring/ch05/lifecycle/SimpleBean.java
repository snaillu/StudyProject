...
public class SimpleBean {
	private static final String DEFAULT_NAME="Super Snail";
	...
	public void init(){
		...
		if(age==Integer.MIN_VALUE){
			throw new IllegalArgumentException("You must set the age property of any beans of type "+this.getClass());
		}
	}
